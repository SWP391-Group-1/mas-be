...
public interface IAppointmentRepository
{
    ...
    Task<PagedResult<AppointmentUserResponse>> GetAllSendAppointmentsAsync(ClaimsPrincipal principal, AppointmentUserParameters param);
    Task<Result<AppointmentUserDetailResponse>> GetAppointmentSendedByIdAsync(ClaimsPrincipal principal, string appointmentId);
    ...
    Task<PagedResult<AppointmentMentorResponse>> GetAllReceiveAppointmentsAsync(ClaimsPrincipal principal, AppointmentMentorParameters param);
    Task<Result<AppointmentMentorDetailResponse>> GetAppointmentReceiveByIdAsync(ClaimsPrincipal principal, string appointmentId);
