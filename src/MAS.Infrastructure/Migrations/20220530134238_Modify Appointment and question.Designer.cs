...
namespace MAS.Infrastructure.Migrations
{
    ...
    [Migration("20220530134238_Modify Appointment and question")]
    partial class ModifyAppointmentandquestion
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAS.Core.Entities.Appointment", b =>
                {
                    b.HasOne("MAS.Core.Entities.MasUser", "Creator")
                        .WithMany("Appointments")
                        .HasForeignKey("CreatorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MAS.Core.Entities.Slot", null)
                        .WithMany("Appointments")
