...
public class SlotRepository : BaseRepository, ISlotRepository
{
        ...
        SlotCreateRequest request)
    {
        ...
        if (request.StartTime.AddHours(7) < DateTime.UtcNow.AddHours(7)) {
            result.Error = ErrorHelper.PopulateError((int)ErrorCodes.BadRequest,
                                                     ErrorTypes.BadRequest,
        ...
        if (DateTime.UtcNow.AddHours(7) > request.StartTime.AddHours(7).AddHours(-2)) {
            result.Error = ErrorHelper.PopulateError((int)ErrorCodes.BadRequest,
                                                     ErrorTypes.BadRequest,
        ...
        if (DateTime.UtcNow.AddHours(7).AddYears(1) < request.StartTime.AddHours(7)) {
            result.Error = ErrorHelper.PopulateError((int)ErrorCodes.BadRequest,
                                                     ErrorTypes.BadRequest,
